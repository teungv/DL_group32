...
project_root = Path(__file__).resolve().parent.parent  # Should resolve to '/home/teunv/Documents/DL/Project/deep_ev_tracker'
if project_root not in sys.path:
    sys.path.append(str(project_root))  # Add the project root to the sys.path
...
results_dir = Path(
    f"/home/teunv/Documents/DL/Project/gt_tracks/benchmark_data/{noise_mode}/{noise_level}"
)
out_dir = Path(
    f"/home/teunv/Documents/DL/Project/benchmark_results/{noise_mode}/{noise_level}"
)
...
with open((out_dir / f"benchmarking_results_{noise_mode}_{noise_level}.csv"), "w") as f:
    for k in tables.keys():
        f.write(f"{k}\n")
